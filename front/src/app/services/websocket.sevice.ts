...
export class WebsocketService {
  ...
  connect(username: string): Promise<void> {
    // Utilise SockJS + STOMP avec gestion d'erreurs
   ...
   */
   // Souscription aux messages du serveur
  public receiveMessageFromWebsocketServer(){
    // Réception des messages et gestion des types spéciaux (JOIN/LEAVE)
  ...
  public disconnect(): void {
    // Envoie une notification de départ et nettoie la connexion
...
// Publie sur le endpoint "/app/sendMessage"
    if (!this.stompClient?.connected) {
      return;
    }
